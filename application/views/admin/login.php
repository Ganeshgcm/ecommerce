      ...
      <div class="col l4 m4 s12">
        <div class="card">
          <div class="card-content">
            ...
            <button type="button" class="t" id="btn" style="background:white; text-transform:capitalize; width:40%; font-weight:500; margin-top:10px;height:40px;">Sig In&nbsp; <span class="fa fa-sign-in-alt"></span>
            </button>
